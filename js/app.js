...
//     this._super(controller, model); // Don't assign to the controller model manually
//     this.controllerFor(...);
//   }
// });
...
Ember.Handlebars.registerBoundHelper('money', function(value) {
  return (value % 100 === 0 ?
          value / 100 + '.00' :
          parseInt(value / 100, 10) + '.' + value % 100); // parseInt(.., base 10)
});
...
// Don't put view specific code in models. User controllers, views or handlebars helpers.
